...
<head>
    ...
    <title>Editar produto - Bodegão</title>
    ...
    <div>
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <input type="number" name="id_produto" id="id_produto" min="1"
                value="<?php echo isset($_GET['id_produto']) ? $_GET['id_produto'] : ''; ?>">
            <br><br>
            ...
            <input type="text" name="marca" id="marca"
                value="<?php echo isset($_GET['marca']) ? $_GET['marca'] : ''; ?>">
            <br><br>
            <label for="tamanho">Tamanho:</label>
            <br>
            <input type="text" name="tamanho" id="tamanho"
                value="<?php echo isset($_GET['tamanho']) ? $_GET['tamanho'] : ''; ?>">
            <br><br>
            <label for="validade">Validade:</label>
            <br>
            <input type="date" name="validade" id="validade"
                value="<?php echo isset($_GET['validade']) ? $_GET['validade'] : ''; ?>">
            <br><br>
            <label for="quantidade">Quantidade em estoque:</label>
            <br>
            <input type="number" name="quantidade" id="quantidade" min="0"
                value="<?php echo isset($_GET['quantidade']) ? $_GET['quantidade'] : ''; ?>">
            <br><br>
            <label for="preco">Preço:</label>
            <br>
            <input type="number" name="preco" id="preco" min="0" step="0.01"
                value="<?php echo isset($_GET['preco']) ? $_GET['preco'] : ''; ?>">
            <hr>
            <button type="submit">
